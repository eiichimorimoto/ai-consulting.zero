      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8 md:p-12 shadow-2xl">
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 販売事業者名</h2>
              <p className="text-sm">株式会社マネジメント総研（SolveWise事業部）</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 運営責任者</h2>
              <p className="text-sm">代表取締役　森本 榮一（Eiichi Morimoto）</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 所在地</h2>
              <p className="text-sm">
                〒463-0048<br />
                愛知県名古屋市徳川町2313
              </p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 販売価格</h2>
              <p className="text-sm">各プランページに記載（消費税込み）</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ サービス開始時期</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 返品・キャンセルについて</h2>
              <p className="text-sm">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 動作環境</h2>
              <p className="text-sm">インターネット接続環境および対応ブラウザが必要です。</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ その他</h2>
              <p className="text-sm">特別な販売条件・提供条件がある場合は、各プラン詳細に明示します。</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-4">■ 反社会的勢力の排除について</h2>
              <p className="text-sm">
