          ...
          <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  {/* 未払い警告 */}
                  <PaymentFailureBanner status={sub.status} appStatus={sub.app_status} />
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {sub.has_stripe_subscription && (
                      <button
                        ...
                        className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-50"
                      >
                    ...
                    {sub.plan_type !== "free" && !sub.cancel_at && (
                      <Link
                        href="/account/cancel"
                        className="flex items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 py-3 font-medium text-red-600 transition-colors hover:bg-red-50"
                      >
                        <XCircle size={16} />
                        解約する
                      </Link>
                    ...
                    {sub.status === "past_due" && (
                      <button
                        ...
                        className="flex items-center justify-center gap-2 rounded-xl bg-yellow-500 px-4 py-3 font-medium text-white transition-colors hover:bg-yellow-600"
                      >
                        <RefreshCw size={16} />
                        再請求を実行
                      </button>
