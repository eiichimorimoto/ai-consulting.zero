...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!reasonCategory || !VALID_REASONS.includes(reasonCategory as typeof VALID_REASONS[number])) {
    ...
    if (!cancelType || !VALID_CANCEL_TYPES.includes(cancelType as typeof VALID_CANCEL_TYPES[number])) {
      return NextResponse.json(
    ...
    return NextResponse.json({
      ...
      message: cancelType === 'end_of_period'
