  ...
  return (
    <>
      ...
      <AlertDialog open={stepToNavigate !== null} onOpenChange={onCancelStepNavigation}>
        <AlertDialogContent className="max-w-md border border-gray-200 bg-white text-gray-900 shadow-xl dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-lg font-semibold text-gray-900 dark:text-slate-100">
              ステップに戻りますか？
            </AlertDialogTitle>
            <AlertDialogDescription className="text-sm leading-relaxed text-gray-600 dark:text-slate-300">
      ...
      <AlertDialog open={isEndingSession} onOpenChange={onSetIsEndingSession}>
        <AlertDialogContent className="max-w-md border border-gray-200 bg-white text-gray-900 shadow-xl dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
          ...
          <div className="space-y-3 py-4">
            <label
              className="flex cursor-pointer items-start gap-3 rounded-lg border-2 border-gray-200 bg-gray-50/50 p-3 transition-colors hover:bg-gray-50 dark:border-slate-600 dark:bg-slate-800/50 dark:hover:bg-slate-800"
            ...
            >
              ...
              />
              <div className="flex-1">
                <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">完了</div>
                <div className="mt-1 text-xs text-gray-600 dark:text-slate-400">
                  課題が解決しました
                </div>
              </div>
            ...
            >
              ...
              />
              <div className="flex-1">
                <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">中止</div>
                <div className="mt-1 text-xs text-gray-600 dark:text-slate-400">
                  この課題は不要になりました
                </div>
              </div>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="text-gray-700 dark:text-slate-300">
              キャンセル
            </AlertDialogCancel>
            <AlertDialogAction
