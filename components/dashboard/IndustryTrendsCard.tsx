            ...
            <div key={idx} style={{ 
              ...
              <div style={{ 
                ...
                <svg viewBox="0 0 24 24" style={{ 
                  width: '18px', 
                  height: '18px', 
                  stroke: trend.direction === 'up' ? '#10b981' : trend.direction === 'down' ? '#ef4444' : '#64748b',
                  fill: 'none',
                  strokeWidth: 2.5
                }}>
                  {trend.direction === 'up' ? (
              ...
              <div style={{ flex: 1 }}>
                <div style={{ 
                  ...
                  <span style={{ 
                    ...
                    color: trend.strength === 'strong' ? '#10b981' : trend.strength === 'moderate' ? '#f59e0b' : '#64748b',
                    fontWeight: '500'
                  }}>
                    {trend.direction === 'up' ? '↑' : trend.direction === 'down' ? '↓' : '→'} {trend.strength === 'strong' ? '強い影響' : trend.strength === 'moderate' ? '中程度' : '弱い'}
                  </span>
                </div>
                ...
                {trend.impact && (
                  <div style={{ fontSize: '11px', color: 'var(--text-light)', fontStyle: 'italic' }}>
                    💡 {trend.impact}
                  </div>
                )}
              </div>
