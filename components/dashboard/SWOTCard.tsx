          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {swotAnalysis?.strengths?.[0]
                    ? typeof swotAnalysis.strengths[0] === "string"
                      ? (swotAnalysis.strengths[0] as string).slice(0, 8)
                      : (swotAnalysis.strengths[0] as any)?.point?.slice(0, 8)
                    : "分析中"}
                  ...
                </span>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  {swotAnalysis?.weaknesses?.[0]
                    ? typeof swotAnalysis.weaknesses[0] === "string"
                      ? (swotAnalysis.weaknesses[0] as string).slice(0, 8)
                      : (swotAnalysis.weaknesses[0] as any)?.point?.slice(0, 8)
                    : "分析中"}
                  ...
                </span>
              </div>
            ...
            {/* 機会 */}
            <div
              className="swot-item opportunity"
              style={{
            ...
            >
              ...
              >
                ...
                >
                  {swotAnalysis?.opportunities?.[0]
                    ? typeof swotAnalysis.opportunities[0] === "string"
                      ? (swotAnalysis.opportunities[0] as string).slice(0, 8)
                      : (swotAnalysis.opportunities[0] as any)?.point?.slice(0, 8)
                    : "分析中"}
                  ...
                </span>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  {swotAnalysis?.threats?.[0]
                    ? typeof swotAnalysis.threats[0] === "string"
                      ? (swotAnalysis.threats[0] as string).slice(0, 8)
                      : (swotAnalysis.threats[0] as any)?.point?.slice(0, 8)
                    : "分析中"}
                  ...
                </span>
              </div>
                    ...
                    const comment =
                      typeof p === "string"
                        ...
                        : typeof p === "object" && p !== null && "comment" in p
                          ...
                          : "情報なし"
                    const source =
                      typeof p === "object" && p !== null && "source" in p ? String(p.source) : null
                    return (
                      <div
                        key={i}
                        style={{
                    ...
                    const comment =
                      typeof n === "string"
                        ...
                        : typeof n === "object" && n !== null && "comment" in n
                          ...
                          : "情報なし"
                    const source =
                      typeof n === "object" && n !== null && "source" in n ? String(n.source) : null
                    return (
                      <div
                        key={i}
                        style={{
