            ...
            <div className="swot-item strength" style={{ 
              ...
              <div className="swot-label" style={{ 
                ...
                <span style={{ 
                  ...
                  {swotAnalysis?.strengths?.[0] ? (typeof swotAnalysis.strengths[0] === 'string' ? (swotAnalysis.strengths[0] as string).slice(0, 8) : (swotAnalysis.strengths[0] as any)?.point?.slice(0, 8)) : '分析中'}...
                </span>
              </div>
            ...
            <div className="swot-item weakness" style={{ 
              ...
              <div className="swot-label" style={{ 
                ...
                <span style={{ 
                  ...
                  {swotAnalysis?.weaknesses?.[0] ? (typeof swotAnalysis.weaknesses[0] === 'string' ? (swotAnalysis.weaknesses[0] as string).slice(0, 8) : (swotAnalysis.weaknesses[0] as any)?.point?.slice(0, 8)) : '分析中'}...
                </span>
              </div>
              <div className="swot-content" style={{ 
                fontSize: '11px', 
            ...
            <div className="swot-item opportunity" style={{ 
              ...
              <div className="swot-label" style={{ 
                ...
                <span style={{ 
                  ...
                  {swotAnalysis?.opportunities?.[0] ? (typeof swotAnalysis.opportunities[0] === 'string' ? (swotAnalysis.opportunities[0] as string).slice(0, 8) : (swotAnalysis.opportunities[0] as any)?.point?.slice(0, 8)) : '分析中'}...
                </span>
              </div>
              <div className="swot-content" style={{ 
                fontSize: '11px', 
            ...
            <div className="swot-item threat" style={{ 
              ...
              <div className="swot-label" style={{ 
                ...
                <span style={{ 
                  ...
                  {swotAnalysis?.threats?.[0] ? (typeof swotAnalysis.threats[0] === 'string' ? (swotAnalysis.threats[0] as string).slice(0, 8) : (swotAnalysis.threats[0] as any)?.point?.slice(0, 8)) : '分析中'}...
                </span>
              </div>
              <div className="swot-content" style={{ 
                fontSize: '11px', 
