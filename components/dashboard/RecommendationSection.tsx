...
export default function RecommendationSection({ industryForecast }: RecommendationSectionProps) {
                ...
                <div style={{ flex: 1 }}>
                    ...
                    {[1, 2, 3, 4, 5].map((level) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "4px",
                          background:
                            level <= (industryForecast?.risks?.length || 2)
                              ? level <= 2
                                ? "#10b981"
                                : level <= 3
                                  ? "#f59e0b"
                  ...
                  <div
                    style={{
                      ...
                      fontWeight: "700",
                      color:
                        (industryForecast?.risks?.length || 2) <= 2
                          ? "#10b981"
                          : (industryForecast?.risks?.length || 2) <= 3
                            ? "#f59e0b"
                            : "#ef4444",
                    }}
                  >
                  ...
                  >
                    ...
                    >
                      {[
                        ...
                        70,
                        65,
                        ind.trend === "up" ? 85 : ind.trend === "down" ? 30 : 50,
                      ].map((h, i) => (
                        <div
                          key={i}
                          style={{
