      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-2 text-xs leading-tight text-gray-300">
              AIで経営課題を解決する次世代コンサルティングサービス
            </p>
            <div className="mt-4 flex gap-2">
              <Link
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-800 text-white transition-colors hover:bg-blue-700"
