      ...
      <TabsContent value="company" className="space-y-6">
        <Card id="company-section" className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          <CardContent className="pt-6 space-y-6 bg-white">
            ...
            <section className="border border-gray-200 rounded-lg overflow-hidden bg-white">
              <h4 className="text-sm font-semibold text-gray-900 bg-gray-50 border-b border-gray-200 px-4 py-2.5">所在地</h4>
              <div className="p-4 space-y-4">
                <div className="grid gap-2">
                  ...
                  {postalCodeStatus && (
                    <p className={`text-sm ${
                      postalCodeStatus.type === 'success' ? 'text-green-600' :
                      postalCodeStatus.type === 'error' ? 'text-red-600' :
                      'text-blue-600'
                    }`}>
            ...
            <section className="border border-gray-200 rounded-lg overflow-hidden bg-white">
              <h4 className="text-sm font-semibold text-gray-900 bg-gray-50 border-b border-gray-200 px-4 py-2.5">詳細情報</h4>
              <div className="p-4 space-y-4">
                <div className="grid gap-2">
                ...
                <div className="grid gap-2">
                  ...
                  <p className="text-xs text-gray-500">例：4月開始（3月決算）の場合は「4月」を選択</p>
                </div>
                <div className="grid gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[100px] px-3 py-2 border border-gray-200 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              ...
              <div className="p-4 space-y-4">
                        ...
                        <DocumentItem
                          ...
                          onDelete={async () => {
                            if (confirm('この資料を削除しますか？')) {
                              ...
                              toast.success('資料を削除しました（保存をクリックして確定してください）')
                            }
                          }}
                        />
                      ))}
                ...
                <div className="grid gap-2">
                  ...
                  {companyDocuments.length > 0 && (
                    <div className="mt-2">
                      <p className="text-sm font-medium text-gray-700 mb-2">選択中のファイル:</p>
                      <ul className="space-y-1">
                        {companyDocuments.map((file, index) => (
                          <li key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded text-sm">
      ...
      <TabsContent value="password" className="space-y-6">
        <Card className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          <CardContent className="pt-6 space-y-4 bg-white">
            <div className="grid gap-2">
              <Label htmlFor="new_password">新しいパスワード <span className="text-red-500">*</span></Label>
              <Input
                id="new_password"
                type="password"
            ...
            <div className="grid gap-2">
              <Label htmlFor="confirm_password">新しいパスワード（確認） <span className="text-red-500">*</span></Label>
              <Input
                id="confirm_password"
                type="password"
