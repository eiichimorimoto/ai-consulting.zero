...
export async function prepareDiagnosisData(companyId: string) {
  ...
  const diagnosisData = {
    ...
    issueFlags: {
      slowWebsite: digitalScore ? (digitalScore.mobile_score < 50 || digitalScore.desktop_score < 50) : false,
      noSSL: digitalScore ? !digitalScore.has_ssl : false,
      notMobileFriendly: digitalScore ? !digitalScore.is_mobile_friendly : false,
      poorWebVitals: digitalScore ? (digitalScore.lcp_mobile > 2500 || digitalScore.fcp_mobile > 1800) : false,
    },
  };
